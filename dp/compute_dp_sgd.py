...
from compute_rdp import compute_rdp
from rdp_convert_dp import compute_eps
...
def apply_dp_sgd_analysis(q, sigma, steps, orders, delta):
    """Compute and print checkpoints of DP-SGD analysis."""
...
if __name__ == "__main__":
    ...
    eps, opt_order = apply_dp_sgd_analysis(300 / 3005, 2.0, 827, orders, 10 ** (-5))
    print("eps:", format(eps) + "| order:", format(opt_order))
